          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-200">
                <div className="w-12 h-12 rounded-lg flex items-center justify-center mb-6" style={{backgroundColor: '#04babd', opacity: 0.1}}>
                  <svg className="w-6 h-6" style={{color: '#04babd'}} fill="none" stroke="currentColor" viewBox="0 0 24 24">
